...
[Releases 페이지](https://github.com/lee-m-h/cockpit/releases)에서 다운로드:
...
**Windows (PowerShell):**
```powershell
irm https://raw.githubusercontent.com/lee-m-h/cockpit/main/install.ps1 | iex
```
...
```bash
git clone https://github.com/lee-m-h/cockpit.git
cd cockpit
./start.sh
```
